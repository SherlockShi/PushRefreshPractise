...
public class AVLoadingIndicatorView extends View {
    ...
    private BallPulseIndicator DEFAULT_INDICATOR;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        DEFAULT_INDICATOR = new BallPulseIndicator(context);
    ...
    public void setIndicator(String indicatorName) {
        ...
        try {
            ...
            Log.e(TAG, "Didn't find your class , check the name again ! indicatorName = " + indicatorName + ", drawableClassName = " + drawableClassName.toString());
